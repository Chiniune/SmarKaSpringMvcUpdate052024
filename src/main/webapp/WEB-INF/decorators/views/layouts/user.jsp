...
<link rel="stylesheet" href="<c:url value='assets/css/vendor/pe-icon-7-stroke.css'/>" />
<link rel="stylesheet" href="<c:url value='assets/css/vendor/themify-icons.css'/>" />
<link rel="stylesheet" href="<c:url value='assets/css/vendor/font-awesome.min.css'/>" />
<link rel="stylesheet" href="<c:url value='assets/css/plugins/animate.css'/>" />
<link rel="stylesheet" href="<c:url value='assets/css/plugins/aos.css'/>" />
<link rel="stylesheet" href="<c:url value='assets/css/plugins/magnific-popup.css'/>" />
<link rel="stylesheet" href="<c:url value='assets/css/plugins/swiper.min.css'/>" />
<link rel="stylesheet" href="<c:url value='assets/css/plugins/jquery-ui.css'/>" />
<link rel="stylesheet" href="<c:url value='assets/css/plugins/nice-select.css'/>" />
<link rel="stylesheet" href="<c:url value='assets/css/plugins/select2.min.css'/>" />
<link rel="stylesheet" href="<c:url value='assets/css/plugins/easyzoom.css'/>" />
<link rel="stylesheet" href="<c:url value='assets/css/plugins/slinky.css'/>" />
...
<body>
			...
			<div class="sidebar-cart-all">
				...
				<div class="cart-content">
					...
					<div class="checkout-btn btn-hover">
						<a class="theme-color" href='<c:url value="/checkout" />'>checkout</a>
					</div>
				</div>
			</div>
		</div>
	...
	<script src="<c:url value='assets/js/vendor/jquery-3.6.0.min.js'/>"></script>
	<script src="<c:url value='assets/js/vendor/jquery-migrate-3.3.2.min.js'/>"></script>
	...
	<script src="<c:url value='assets/js/plugins/wow.js'/>"></script>
	<script src="<c:url value='assets/js/plugins/scrollup.js'/>"></script>
	<script src="<c:url value='assets/js/plugins/aos.js'/>"></script>
	<script src="<c:url value='assets/js/plugins/magnific-popup.js'/>"></script>
	<script src="<c:url value='assets/js/plugins/jquery.syotimer.min.js'/>"></script>
	<script src="<c:url value='assets/js/plugins/swiper.min.js'/>"></script>
	<script src="<c:url value='assets/js/plugins/imagesloaded.pkgd.min.js'/>"></script>
	<script src="<c:url value='assets/js/plugins/isotope.pkgd.min.js'/>"></script>
	<script src="<c:url value='assets/js/plugins/jquery-ui.js'/>"></script>
	<script src="<c:url value='assets/js/plugins/jquery-ui-touch-punch.js'/>"></script>
	...
	<script src="<c:url value='assets/js/plugins/select2.min.js'/>"></script>
	<script src="<c:url value='assets/js/plugins/easyzoom.js'/>"></script>
	<script src="<c:url value='assets/js/plugins/slinky.min.js'/>"></script>
	<script src="<c:url value='assets/js/plugins/ajax-mail.js'/>"></script>
	<!-- Main JS -->
	<script src="<c:url value='assets/js/main.js'/>"></script>
	<script src="<c:url value='assets/js/mic2.js'/>"></script>
	<!-- SweetAlert JS -->
	<%-- <link rel='stylesheet'
	...
	<script src="<c:url value='assets/js/userCart.js'/>"></script>
	<script src="<c:url value='assets/js/auth.js'/>"></script>
